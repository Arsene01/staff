  ...
  describe("Creating state...", () => {
    ...
    describe("creating positions...", () => {
      ...
      test("when add position with name 'заместитель командира батальона'", () => {
        ...
        const data = p.addPositionData({
          positionNameId: p.getPositionNameId(
    ...
    describe("checking position names...", () => {
      test("when input is 1", () => {
        expect(d.getPositionFullname(1)).toEqual(
          "командир батальона 1 мотострелкового батальона войсковой части 16544"
        );
      });
      test("when input is 2", () => {
        expect(d.getPositionFullname(2)).toEqual(
          "заместитель командира батальона 1 мотострелкового батальона войсковой части 16544"
        );
      });
      test("when input is 3", () => {
        expect(d.getPositionFullname(3)).toEqual(
          "заместитель командира батальона по военно-политической работе 1 мотострелкового батальона войсковой части 16544"
        );
      });
      test("when input is 4", () => {
        expect(d.getPositionFullname(4)).toEqual(
          "заместитель командира батальона по вооружению 1 мотострелкового батальона войсковой части 16544"
        );
      });
      test("when input is 5", () => {
        expect(d.getPositionFullname(5)).toEqual(
          "начальник штаба - заместитель командира батальона штаба 1 мотострелкового батальона войсковой части 16544"
        );
      });
      test("when input is 6", () => {
        expect(d.getPositionFullname(6)).toEqual(
          "заместитель начальника штаба штаба 1 мотострелкового батальона войсковой части 16544"
        );
      });
      test("when input is 7", () => {
        expect(d.getPositionFullname(7)).toEqual(
          "инструктор штаба 1 мотострелкового батальона войсковой части 16544"
        );
      });
      test("when input is 8", () => {
        expect(d.getPositionFullname(8)).toEqual(
          "командир роты 1 мотострелковой роты 1 мотострелкового батальона войсковой части 16544"
        );
      });
      test("when input is 9", () => {
        expect(d.getPositionFullname(9)).toEqual(
          "заместитель командира роты по военно-политической работе 1 мотострелковой роты 1 мотострелкового батальона войсковой части 16544"
        );
      });
      test("when input is 10", () => {
        expect(d.getPositionFullname(10)).toEqual(
          "старший техник 1 мотострелковой роты 1 мотострелкового батальона войсковой части 16544"
        );
      });
      test("when input is 11", () => {
        expect(d.getPositionFullname(11)).toEqual(
          "старшина 1 мотострелковой роты 1 мотострелкового батальона войсковой части 16544"
        );
      });
      test("when input is 12", () => {
        expect(d.getPositionFullname(12)).toEqual(
          "фельдшер 1 мотострелковой роты 1 мотострелкового батальона войсковой части 16544"
        );
      });
      test("when input is 13", () => {
        expect(d.getPositionFullname(13)).toEqual(
          "командир отделения 1 мотострелковой роты 1 мотострелкового батальона войсковой части 16544"
        );
      });
      test("when input is 14", () => {
        expect(d.getPositionFullname(14)).toEqual(
          "старший водитель 1 мотострелковой роты 1 мотострелкового батальона войсковой части 16544"
        );
      });
      test("when input is 15", () => {
        expect(d.getPositionFullname(15)).toEqual(
          "наводчик 1 мотострелковой роты 1 мотострелкового батальона войсковой части 16544"
        );
      });
      test("when input is 16", () => {
        expect(d.getPositionFullname(16)).toEqual(
          "радиотелефонист 1 мотострелковой роты 1 мотострелкового батальона войсковой части 16544"
        );
      });
      test("when input is 17", () => {
        expect(d.getPositionFullname(17)).toEqual(
          "оператор 1 мотострелковой роты 1 мотострелкового батальона войсковой части 16544"
        );
      });
      test("when input is 18", () => {
        expect(d.getPositionFullname(18)).toEqual(
          "командир взвода 1 мотострелкового взвода 1 мотострелковой роты 1 мотострелкового батальона войсковой части 16544"
        );
      });
    });
  });
  describe("Filling data...", () => {
    ...
    describe("setting initial person ranges", () => {
      ...
      test("'старший лейтенант' to person with id 8", () => {
        ...
        expect(P.getRange(8, toNumber("26.12.2016"))).toEqual(
          "старший лейтенант"
        );
      });
      ...
      test("'старший сержант' to person with id 10", () => {
        ...
        expect(P.getRange(10, toNumber("26.12.2016"))).toEqual(
          "старший сержант"
        );
      });
      ...
      test("'младший сержант' to person with id 14", () => {
        ...
        expect(P.getRange(14, toNumber("26.12.2016"))).toEqual(
          "младший сержант"
        );
      });
    ...
    describe("setting persons to their positions", () => {
      test("when input has no date and case", () => {
        let i = 1;
        while (i <= 18) {
          ps.applyPosition(i, i, toNumber("26.12.2016"));
          i += 1;
        }
        expect(P.getRangeFullnamePosition(1)).toEqual(
          "подполковник Кабиев Тлектес Серикович, командир батальона 1 мотострелкового батальона войсковой части 16544"
        );
      });
      test("when input has persinId 2, date and case", () => {
        expect(
          P.getRangeFullnamePosition(2, toNumber(today()), "dative")
        ).toEqual(
          "майору Сергиенко Николаю Васильевичу, заместителю командира батальона 1 мотострелкового батальона войсковой части 16544"
        );
      });
      test("when input has persinId 3, date and case", () => {
        expect(
          P.getRangeFullnamePosition(3, toNumber(today()), "dative")
        ).toEqual(
          "капитану Ерофееву Матвею Андреевичу, заместителю командира батальона по военно-политической работе 1 мотострелкового батальона войсковой части 16544"
        );
      });
      test("when input has persinId 4, date and case", () => {
        expect(
          P.getRangeFullnamePosition(4, toNumber(today()), "dative")
        ).toEqual(
          "майору Велитарскому Александру Геннадьевичу, заместителю командира батальона по вооружению 1 мотострелкового батальона войсковой части 16544"
        );
      });
      test("when input has persinId 5, date and case", () => {
        expect(
          P.getRangeFullnamePosition(5, toNumber(today()), "dative")
        ).toEqual(
          "майору Бокову Мустафе Курашевичу, начальнику штаба - заместителю командира батальона штаба 1 мотострелкового батальона войсковой части 16544"
        );
      });
      test("when input has persinId 6, date and case", () => {
        expect(
          P.getRangeFullnamePosition(6, toNumber(today()), "dative")
        ).toEqual(
          "капитану Тутурову Игорю Викторовичу, заместителю начальника штаба штаба 1 мотострелкового батальона войсковой части 16544"
        );
      });
      test("when input has persinId 7, date and case", () => {
        expect(
          P.getRangeFullnamePosition(7, toNumber(today()), "dative")
        ).toEqual(
          "сержанту Садуллаеву Юсупу Сайдмагомедовичу, инструктору штаба 1 мотострелкового батальона войсковой части 16544"
        );
      });
      test("when input has persinId 8, date and case", () => {
        expect(
          P.getRangeFullnamePosition(8, toNumber(today()), "dative")
        ).toEqual(
          "старшему лейтенанту Кулбахтину Илюзу Филюзовичу, командиру роты 1 мотострелковой роты 1 мотострелкового батальона войсковой части 16544"
        );
      });
      test("when input has persinId 9, date and case", () => {
        expect(
          P.getRangeFullnamePosition(9, toNumber(today()), "dative")
        ).toEqual(
          "лейтенанту Лебедеву Алексею Васильевичу, заместителю командира роты по военно-политической работе 1 мотострелковой роты 1 мотострелкового батальона войсковой части 16544"
        );
      });
      test("when input has persinId 10, date and case", () => {
        expect(
          P.getRangeFullnamePosition(10, toNumber(today()), "dative")
        ).toEqual(
          "старшему сержанту Джамалудинову Али Дибировичу, старшему технику 1 мотострелковой роты 1 мотострелкового батальона войсковой части 16544"
        );
      });
      test("when input has persinId 11, date and case", () => {
        expect(
          P.getRangeFullnamePosition(11, toNumber(today()), "dative")
        ).toEqual(
          "прапорщику Адилову Тажидину Исаевичу, старшине 1 мотострелковой роты 1 мотострелкового батальона войсковой части 16544"
        );
      });
      test("when input has persinId 12, date and case", () => {
        expect(
          P.getRangeFullnamePosition(12, toNumber(today()), "dative")
        ).toEqual(
          "сержанту Малиновской Марине Жамалудиновне, фельдшеру 1 мотострелковой роты 1 мотострелкового батальона войсковой части 16544"
        );
      });
      test("when input has persinId 13, date and case", () => {
        expect(
          P.getRangeFullnamePosition(13, toNumber(today()), "dative")
        ).toEqual(
          "сержанту Дулину Виктору Валентиновичу, командиру отделения 1 мотострелковой роты 1 мотострелкового батальона войсковой части 16544"
        );
      });
      test("when input has persinId 14, date and case", () => {
        expect(
          P.getRangeFullnamePosition(14, toNumber(today()), "dative")
        ).toEqual(
          "младшему сержанту Арясову Виталию Павловичу, старшему водителю 1 мотострелковой роты 1 мотострелкового батальона войсковой части 16544"
        );
      });
      test("when input has persinId 15, date and case", () => {
        expect(
          P.getRangeFullnamePosition(15, toNumber(today()), "dative")
        ).toEqual(
          "рядовому Сайгидулаеву Ахмеду Шагидхановичу, наводчику 1 мотострелковой роты 1 мотострелкового батальона войсковой части 16544"
        );
      });
      test("when input has persinId 16, date and case", () => {
        expect(
          P.getRangeFullnamePosition(16, toNumber(today()), "dative")
        ).toEqual(
          "рядовому Багамаеву Жамалу Джамалутдиновичу, радиотелефонисту 1 мотострелковой роты 1 мотострелкового батальона войсковой части 16544"
        );
      });
      test("when input has persinId 17, date and case", () => {
        expect(
          P.getRangeFullnamePosition(17, toNumber(today()), "dative")
        ).toEqual(
          "рядовому Дурдыеву Анзору Лавереновичу, оператору 1 мотострелковой роты 1 мотострелкового батальона войсковой части 16544"
        );
      });
      test("when input has persinId 18, date and case", () => {
        expect(
          P.getRangeFullnamePosition(18, toNumber(today()), "dative")
        ).toEqual(
          "лейтенанту Охотникову Александру Валерьевичу, командиру взвода 1 мотострелкового взвода 1 мотострелковой роты 1 мотострелкового батальона войсковой части 16544"
        );
      });
    });
  });
